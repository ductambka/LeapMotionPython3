...
#
# sys.path.append('/Users/apple/Tnd-Projects/Leap-Python3/lib/x64')

import LeapPython3

# imp.import_module("LeapPython")
...
#         #
#         # try:
#         #     fp, pathname, description = importlib.find_module('LeapPython', [dirname(__file__)])
#         # except ImportError:
#         #     import LeapPython
#         #     return LeapPython
#         if fp is not None:
#             try:
#                 _mod = importlib.load_module('LeapPython', fp, pathname, description)
#             finally:
#                 fp.close()
#             return _mod
#
...
class Frame(Interface):
    ...
    if _newclass: serialize = property(serialize)
